...
export default function LoginPage() {
  ...
  return (
    ...
    <div className="min-h-[85vh] flex">
      ...
      {/* Right Side - Form */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-earth-50/50 dark:bg-earth-900/50">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white dark:bg-earth-900 rounded-2xl shadow-xl border border-earth-200 dark:border-earth-700 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label htmlFor="username" className="block text-sm font-medium text-gray-700 dark:text-earth-200 mb-2">
                  Email or Username
                </label>
                <div className="relative">
                  <input
                    ...
                    className={`w-full pl-11 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-earth-500 focus:border-earth-500 transition dark:bg-earth-800 dark:text-earth-100 ${
                      fieldErrors.username ? 'border-red-300 bg-red-50' : 'border-gray-300 dark:border-earth-600'
                    }`}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full pl-11 pr-12 py-3 border rounded-xl focus:ring-2 focus:ring-earth-500 focus:border-earth-500 transition dark:bg-earth-800 dark:text-earth-100 ${
                      fieldErrors.password ? 'border-red-300 bg-red-50' : 'border-gray-300 dark:border-earth-600'
                    }`}
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-4 h-4 rounded border-gray-300 dark:border-earth-600 text-earth-600 focus:ring-earth-500 dark:bg-earth-800"
                  />
                  <span className="text-sm text-gray-600 dark:text-earth-300">Remember me</span>
                </label>
                <Link
                  href="/forgot-password"
                  className="text-sm text-earth-600 dark:text-sage-400 hover:text-gray-800 dark:hover:text-sage-300 font-medium"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="mt-6">
              <div className="relative">
                <div className="absolute inset-0 flex items-center">
                  <div className="w-full border-t border-gray-200 dark:border-earth-700" />
                </div>
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white dark:bg-earth-900 text-gray-500 dark:text-earth-400">Or continue with</span>
                </div>
              </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 dark:border-earth-600 rounded-xl hover:bg-gray-50 dark:hover:bg-earth-800 transition"
                >
                  ...
                  <span className="text-sm font-medium text-gray-700 dark:text-earth-200">Google</span>
                </button>
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 dark:border-earth-600 rounded-xl hover:bg-gray-50 dark:hover:bg-earth-800 transition"
                >
                  ...
                  <span className="text-sm font-medium text-gray-700 dark:text-earth-200">GitHub</span>
                </button>
              </div>
            </div>
          </div>

          <p className="text-center mt-8 text-gray-600 dark:text-earth-300">
            Don&apos;t have an account?{' '}
            <Link href="/register" className="text-earth-600 dark:text-sage-400 hover:text-gray-800 dark:hover:text-sage-300 font-semibold">
              Create one free
            </Link>
          </p>
