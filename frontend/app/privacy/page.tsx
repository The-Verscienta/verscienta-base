    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="bg-white rounded-2xl shadow-lg border border-earth-200 p-8 md:p-12">
        <div className="prose prose-earth max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-serif font-bold text-gray-800 mb-4">How We Use Your Information</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-serif font-bold text-gray-800 mb-4">Data Sharing and Disclosure</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-serif font-bold text-gray-800 mb-4">Cookies and Tracking</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-serif font-bold text-gray-800 mb-4">Data Security</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-serif font-bold text-gray-800 mb-4">Your Rights</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-serif font-bold text-gray-800 mb-4">Children's Privacy</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-earth-50 rounded-lg p-4 mt-4">
              <p className="text-gray-800">
                ...
                Email: <a href="mailto:privacy@verscienta.health" className="text-gray-600 hover:text-gray-800">privacy@verscienta.health</a>
              </p>
            </div>
          </section>
        </div>
