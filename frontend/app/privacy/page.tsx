    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-earth-50 via-sage-50/50 to-cream-100 dark:from-earth-950 dark:via-earth-900 dark:to-earth-950 border-b border-sage-200/50 dark:border-earth-700">
      ...
      <div className="relative max-w-4xl mx-auto px-4 py-12 md:py-16 text-center">
        <div className="inline-flex items-center gap-2 bg-white/60 dark:bg-earth-900/60 backdrop-blur-sm rounded-full px-4 py-2 border border-earth-200/50 dark:border-earth-700 mb-6">
          ...
          <span className="text-gray-600 dark:text-earth-300 font-medium text-sm">Your Privacy Matters</span>
        </div>
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="bg-white dark:bg-earth-900 rounded-2xl shadow-lg border border-earth-200 dark:border-earth-700 p-8 md:p-12">
        <div className="prose prose-earth dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-serif font-bold text-gray-800 dark:text-earth-100 mb-4">Information We Collect</h2>

            <h3 className="text-lg font-semibold text-gray-700 dark:text-earth-200 mt-4 mb-2">Personal Information</h3>
            ...
            <h3 className="text-lg font-semibold text-gray-700 dark:text-earth-200 mt-4 mb-2">Automatically Collected Information</h3>
            <p className="text-gray-700 dark:text-earth-200 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-serif font-bold text-gray-800 dark:text-earth-100 mb-4">How We Use Your Information</h2>
            <p className="text-gray-700 dark:text-earth-200 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-serif font-bold text-gray-800 dark:text-earth-100 mb-4">Data Sharing and Disclosure</h2>
            <p className="text-gray-700 dark:text-earth-200 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-serif font-bold text-gray-800 dark:text-earth-100 mb-4">Cookies and Tracking</h2>
            <p className="text-gray-700 dark:text-earth-200 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-serif font-bold text-gray-800 dark:text-earth-100 mb-4">Data Security</h2>
            <p className="text-gray-700 dark:text-earth-200 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-serif font-bold text-gray-800 dark:text-earth-100 mb-4">Your Rights</h2>
            <p className="text-gray-700 dark:text-earth-200 leading-relaxed mb-3">
          ...
          <section>
            ...
            <div className="bg-earth-50 dark:bg-earth-950 rounded-lg p-4 mt-4">
              <p className="text-gray-800 dark:text-earth-100">
                ...
                Email: <a href="mailto:privacy@verscienta.health" className="text-gray-600 dark:text-earth-300 hover:text-gray-800 dark:hover:text-earth-100">privacy@verscienta.health</a>
              </p>
            </div>
          </section>
        </div>
