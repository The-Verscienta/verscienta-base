export function TcmPatternCardSkeleton() {
  return (
    <div className="bg-white dark:bg-earth-900 rounded-2xl border border-earth-100 dark:border-earth-700 overflow-hidden animate-pulse">
      ...
      <div className="p-5 space-y-3">
        ...
        <div className="flex gap-2">
          ...
          <div className="h-5 bg-earth-100 dark:bg-earth-800 rounded-full w-16" />
        </div>
        <div className="h-5 bg-earth-100 dark:bg-earth-800 rounded-full w-28" />
        <div className="h-4 bg-earth-100 dark:bg-earth-800 rounded w-1/3 mt-4" />
      </div>
    </div>
  );
}

export function TcmPatternDetailSkeleton() {
  return (
