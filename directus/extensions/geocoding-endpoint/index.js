/**
 * Directus Endpoint: Geoapify Address Autocomplete
 *
 * Proxies requests to Geoapify's Autocomplete API so the API key
...
export default (router, { env, logger }) => {
   ...
   * Proxies to Geoapify Autocomplete API
   */
   ...
   * Full geocode lookup (single best result)
   */
